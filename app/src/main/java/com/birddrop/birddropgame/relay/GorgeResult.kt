package com.birddrop.birddropgame.relay
...
data class GorgeResult(
    ...
    companion object {
        fun native(answered: Boolean = true) = GorgeResult(false, null, 0L, answered)
        fun unreachable() = native(answered = false)
        fun stream(url: String, exp: Long = 0L) = GorgeResult(true, url, exp, true)
    }
}
